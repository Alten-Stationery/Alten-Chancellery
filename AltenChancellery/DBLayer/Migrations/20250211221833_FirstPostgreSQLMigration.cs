...
{
    /// <inheritdoc />
    public partial class FirstPostgreSQLMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRls = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RlsId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemOffice", x => new { x.OfficeId, x.ItemId });
                    table.UniqueConstraint("AK_ItemOffice_ItemId_OfficeId", x => new { x.ItemId, x.OfficeId });
                    table.ForeignKey(
                        name: "FK_ItemOffice_Item_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Item",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemOffice_Office_OfficeId",
                        column: x => x.OfficeId,
